...
- **Measured retrieval** — an 87-question golden set across three query categories scores the pipeline on hit@5, recall@5, MRR, and nDCG@5, gated in CI so retrieval quality cannot regress silently ([docs/evaluation.md](docs/evaluation.md))
