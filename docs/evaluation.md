...
Measured on 73 chunks and the 22 held-out golden questions at `38ea92e`.
...
**Production runs Keyword only, tied for the lead on hit@5 (1.000) with Keyword, then re-ranked.**
