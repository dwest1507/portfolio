...
Measured on 100 chunks and the 22 held-out golden questions at `5a2aa28`.

| Arm | recall@5 | hit@5 | MRR | ndcg@5 |
|-----|---------:|---------:|---------:|---------:|
| `bm25` _(shipped)_ | **0.721** | **1.000** | **0.918** | **0.834** |
| `dense` | 0.569 | 0.864 | 0.706 | 0.606 |
| `hybrid` | 0.597 | 0.955 | 0.788 | 0.672 |
| `rerank` | 0.604 | 0.955 | 0.909 | 0.733 |
| `bm25+rerank` | 0.644 | 0.955 | 0.909 | 0.765 |
