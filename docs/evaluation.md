...
Measured on 100 chunks and the 33 held-out golden questions at `ebe7cca`.

| Arm | recall@5 | hit@5 | MRR | ndcg@5 |
|-----|---------:|---------:|---------:|---------:|
| `bm25` _(shipped)_ | **0.639** | **0.970** | 0.822 | **0.727** |
| `dense` | 0.498 | 0.849 | 0.685 | 0.539 |
| `hybrid` | 0.527 | 0.909 | 0.752 | 0.596 |
| `rerank` | 0.574 | 0.939 | **0.834** | 0.676 |
| `bm25+rerank` | 0.596 | 0.909 | 0.833 | 0.694 |

**Production runs Keyword only, which also leads on hit@5 (0.970).**
